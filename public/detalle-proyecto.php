...
require __DIR__ . '/../app/Models/Came.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        ...
        case 'create_obj_est':
            ...
            break;
        case 'save_objetivos_batch':
            $controller->saveObjetivosBatch();
            break;
        case 'update_obj_est':
        ...
        case 'save_perfil_competitivo_autosave_batch':
            ...
            break;
        case 'save_pest_autosave_batch':
            $controller->savePestAutosaveBatch();
            break;
        case 'save_pest_batch':
            $controller->savePestBatch();
            break;
        case 'save_foda_perfil_competitivo':
            $controller->saveFodaPerfilCompetitivo();
            break;
        case 'save_foda_pest':
        ...
        case 'save_foda_cruzada_batch':
            ...
            break;
        case 'save_came_autosave_batch':
            $controller->saveCameAutosaveBatch();
            break;
        case 'save_came_batch':
            $controller->saveCameBatch();
            break;
